...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  {{-- <nav class="mt-5 px-2">
           ...
           <a href="{{route('approve.followRequest')}}" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
    <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24">
        <!-- Replace the existing path data with the path data for a different icon -->
