    ...
    <div class="" style="background-color: #15202b;">
        <div class="flex">
            ...
            <div class="w-2/5 text-white h-12 pl-32 py-4 h-auto">
              ...
              <nav class="mt-5 px-2">
                <a href="{{route('tweets.index')}}" class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-blue-800 text-blue-300">
            ...
            <a href="#" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
              ...
              Lists
                ...
                <a href="{{route('profile.show')}}" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
            ...
            <a href="{{route('logout')}}" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
                <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                logOut
              </a>
                  ...
                  <div class="flex">
                      ...
                      <div class="flex-1 px-2 pt-2 mt-2">
                          <form action="{{ route('tweets.store') }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <textarea class="bg-transparent text-gray-400 font-medium text-lg w-full" name="content" rows="2" cols="50" placeholder="What's happening?"></textarea>
                      </div>
                  </div>
