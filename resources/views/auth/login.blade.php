            ...
            <div class="flex min-h-screen items-center justify-center">
                ...
                <div class="min-h-1/2 bg-gray-900  border border-gray-900 rounded-2xl">
                    ...
                    <div
                        ...
                        <h1 class="text-white text-2xl">Login Twitter</h1>
                        <input class="w-full p-2 bg-gray-900 rounded-md  border border-gray-700 focus:border-blue-700"
                            placeholder="Correo" type="email"@error('email') is-invalid @enderror" name="email"
                        ...
                        <input class="w-full p-2 bg-gray-900 rounded-md border border-gray-700 " placeholder="password*"
                            type="password" @error('password') is-invalid @enderror name="password" required
                        ...
                        @enderror
                        <input
                            class="w-full p-2 bg-gray-50 rounded-full font-bold text-gray-900 hover:bg-gray-700 border border-gray-700 "
                            type="submit" name="correo" id="" value="login">

                        <p>Create Acc ?
                            <a
                                class="font-semibold text-sky-500 hover:text-sky-700   "href="{{ route('register') }}">{{ __('Register') }}</a>
                    </div>
